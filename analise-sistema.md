...
- **Avaliação do sistema:** descrição das 15 perguntas realizadas, com entradas, saídas, documentos recuperados e classificação das respostas.
...
| **Causa** | Durante a geração, o LLM perde o mapeamento entre o índice interno da fonte (ex: "Fonte 1") e o nome real do arquivo. Isso ocorre porque o contexto RAG é injetado no prompt com rótulos numéricos (Fonte 1, Fonte 2...), e o modelo nem sempre preserva a correspondência correta ao citar. |
